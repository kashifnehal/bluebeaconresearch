  ...
  return (
    ...
    >
      ...
      <div style={{ position: "fixed", inset: 0, pointerEvents: "none", zIndex: 0, opacity: 0.2 }}>
        <div style={{ position: "absolute", bottom: 0, left: 0, width: "500px", height: "500px", background: "rgba(78,222,163,0.05)", filter: "blur(120px)", borderRadius: "50%" }} />
        <div style={{ position: "absolute", top: 0, right: 0, width: "400px", height: "400px", background: "rgba(114,223,77,0.05)", filter: "blur(100px)", borderRadius: "50%" }} />
      </div>
      ...
      >
        {/* Status ribbon */}
        <div style={{ position: "absolute", top: 0, left: 0, width: "100%", height: "2px", background: C.primaryContainer }} />
        ...
        <header style={{ display: "flex", flexDirection: "column", alignItems: "center", marginBottom: "32px" }}>
          ...
          <div style={{ textAlign: "center" }}>
            <h1 style={{ fontFamily: "'Inter', sans-serif", fontSize: "24px", fontWeight: 700, letterSpacing: "-0.02em", color: C.onSurface, marginBottom: "8px" }}>
              Create your account
            </h1>
            <p style={{ fontFamily: "'Space Grotesk', sans-serif", fontSize: "12px", color: C.onSurfaceVariant, textTransform: "uppercase", letterSpacing: "0.1em" }}>
              Start monitoring conflict intelligence
            </p>
          </div>
        </header>
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
          ...
          <div>
            ...
            <input id="fullName" type="text" placeholder="Your name" style={inputStyle} {...form.register("fullName")}
          ...
          <div>
            ...
            <input id="email" type="email" placeholder="you@example.com" style={inputStyle} {...form.register("email")}
              onFocus={(e) => { e.target.style.borderBottomColor = C.primaryContainer; }}
              onBlur={(e) => { e.target.style.borderBottomColor = C.outlineVariant; }}
            />
          ...
          <div>
            ...
            <div style={{ position: "relative" }}>
              <input id="password" type={showPassword ? "text" : "password"} placeholder="••••••••" style={{ ...inputStyle, paddingRight: "40px" }} {...form.register("password")}
                onFocus={(e) => { e.target.style.borderBottomColor = C.primaryContainer; }}
                onBlur={(e) => { e.target.style.borderBottomColor = C.outlineVariant; }}
              />
          ...
          {/* Error */}
          {error && (
            <div style={{ padding: "12px", backgroundColor: "rgba(255,180,171,0.1)", border: "1px solid rgba(255,180,171,0.2)", borderRadius: "4px" }}>
              <p style={{ color: C.error, fontFamily: "'JetBrains Mono', monospace", fontSize: "11px", textAlign: "center" }}>{error}</p>
            </div>
          )}
