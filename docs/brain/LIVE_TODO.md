...
- #138 Site-wide copy & error-state integrity pass — **Phase 2 candidates closed
  2026-09-13** (see "Closed, verified"). Remainder: short internal voice guide +
  `api-response.ts` catalog (route error *shape*, not a user-rendered toast). Do
  not fold into another UI ticket.
