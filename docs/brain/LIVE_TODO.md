...
- #121 Real /accuracy page + outcome-tracker worker — spec'd, full build recommendation
  exists; gated on real signal history being long enough to be honest. #53 backfill
  ran 2026-09-11 (filled 767→1,634); 201 historical empties remain because Anthropic
  credit exhausted mid-run.
