...
- `is_test_account` (`boolean`, NOT NULL, default `false`) — #146, 2026-09-19. Prospect/demo flag excluded from usage metrics. Full note in `docs/brain/04_DATABASE.md` Table 1.
