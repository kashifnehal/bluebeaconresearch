...
> **📍 Doc status — reusable IDE/marketing prompts.** Runtime Claude prompts live in `claude.service.ts` and are documented in `18_AI_ENGINE.md`. `claude/23_TODO.md` is not in this repo.
