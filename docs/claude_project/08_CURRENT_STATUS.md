...
> **📍 Doc status — live status banners as of 2026-09-23 (#186 Phase 5a: 4 more pages with the Phase-2 bug, worse).** Full technical matrix: `docs/brain/08_CURRENT_STATUS.md`. `claude/23_TODO.md` / `22_SESSION_HANDOFF.md` are not in this repo.
