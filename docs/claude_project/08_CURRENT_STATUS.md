...
> **📍 Doc status — live status banners as of 2026-09-23 (#186: real overflow bugs found + fixed post-founder-report; verification method itself fixed).** Full technical matrix: `docs/brain/08_CURRENT_STATUS.md`. `claude/23_TODO.md` / `22_SESSION_HANDOFF.md` are not in this repo. **See `docs/brain/HANDOFF_186_PHASE5.md` for background; Phase 6 (768px tablet pass) is now the only open item in #186.**
