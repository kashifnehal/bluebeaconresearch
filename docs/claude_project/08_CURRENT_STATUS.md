...
> **📍 Doc status — live status banners as of 2026-09-25 (#202/#203/#204/#205/#206/#199 six mobile-polish fixes closed — see the banner immediately below).** Full technical matrix: `docs/brain/08_CURRENT_STATUS.md`. `claude/23_TODO.md` / `22_SESSION_HANDOFF.md` are not in this repo. **Open items left in #186: the Quick View modal design decision; 6 not-yet-approved "new functionality" ideas written up as a Claude Artifact detail sheet, not a repo doc; and #206's uptime-sparkline half (row-crowding half closed this pass).**
