...
**Verified:** `tsc --noEmit` clean; unit tests (`CommodityChip`, `MarketImpactAssessment`) pass. No live-browser walkthrough — not required per the token-discipline Playwright carve-out (none of these six are visual/rendering bugs). Full detail: `docs/brain/14_CHANGELOG.md` v0.94.0, `docs/brain/LIVE_TODO.md`.
